...
| --- | --- |
| Frontend | TypeScript, Next.js, React, component systems, product UI |
...
- Build the smallest useful system first, then harden it with real feedback.
- Prefer clear APIs, readable architecture, and documented tradeoffs.
- Treat automation as a product surface: observable, reversible, and safe.
- Keep the user experience practical, fast, and grounded in the real workflow.
